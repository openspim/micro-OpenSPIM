...
import spim.algorithm.AbstractAntiDrift;
 ...
 */
public class AntiDriftAdjustWindow extends JFrame implements KeyListener
{
	 ...
	 * @param zratio the zratio
	 */
	public AntiDriftAdjustWindow( final double x, final double y, final double z, final double theta, final double zratio )
	{
