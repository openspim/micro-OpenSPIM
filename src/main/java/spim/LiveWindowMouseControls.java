...
public class LiveWindowMouseControls extends MouseAdapter {
	...
	private SPIMCalibrator calibrator;
	...
	public LiveWindowMouseControls() {
		hookedOn = null;
		setup = null;
		calibrator = null;
	 ...
	 */
	public boolean attach(Component to, SPIMSetup isetup, SPIMCalibrator icalibrator, int unhookMM) {
		if(hookedOn != null)
			detach();
