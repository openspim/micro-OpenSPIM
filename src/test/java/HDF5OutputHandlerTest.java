	...
	public void process() throws Exception
	{
		...
		for (int t=1; t <= time; t++)
		{
			...
			for (int z=1; z <= depth; z++) {
				handler.processSlice( t - 1, 0, firstChannel0.getStack().getProcessor( z ), 0, 0, z - 1, 0, t - 1 );
			}
			...
			for (int z=1; z <= depth; z++) {
				handler.processSlice( t - 1, 1, firstChannel1.getStack().getProcessor( z ), 1, 0, z - 1, 1, t - 1 );
			}
