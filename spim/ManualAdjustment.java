...
public class ManualAdjustment {
	...
	public static void main(String[] args) {
		final ImagePlus imp1 = WindowManager.getImage("flybrain.tif (red)");
		final ImagePlus imp2 = WindowManager.getImage("flybrain.tif (green)");
		new AdjusterGUI(imp1, imp2, new Callback() {
			public void offset(int dx, int dy, int dz) {
				IJ.log("User selected " + dx + ", " + dy + ", " + dz);
			}
		}).setVisible(true);
	}
}